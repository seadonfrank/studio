...
export default function LicenseCredentialCard({ 
  licenseType, issuingAuthority, name, issueDate, expiryDate, licenseNumber, details, gradient, status 
}: LicenseCredentialCardProps) {
      ...
      <CardContent className="p-4">
        <div className="flex justify-between items-start mb-2">
          <div className="flex flex-col gap-0.5">
            <span className="text-[10px] font-bold uppercase tracking-wider opacity-70">{licenseType}</span>
