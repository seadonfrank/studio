...
const fundSchema = z.object({
  ...
  investedAmount: z.string().refine(val => !isNaN(parseFloat(val)) && parseFloat(val) > 0, {
...
export default function ManageFundsDialog() {
  ...
  function onSubmit(data: FundFormValues) {
    console.log(data);
    form.reset();
    toast({
      title: "Fund Investment Added",
      description: `Your new investment in ${data.fundName} has been added.`,
    });
  }
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="E.g., Tech Growth Fund" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
