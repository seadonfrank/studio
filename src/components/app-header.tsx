...
export default function AppHeader() {
  return (
    <header className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between bg-background/80 p-4 backdrop-blur-sm">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-xl font-headline font-bold text-foreground">xIDFI Wallet</h1>
      </div>
      <div className="flex items-center gap-2">
