...
interface ScanToVerifyViewProps {
  onBack: () => void;
}

export default function ScanToVerifyView({ onBack }: ScanToVerifyViewProps) {
        ...
        return (
          <>
            ...
            <p className="text-muted-foreground text-center">
              Position the verification QR code within the frame.
            </p>
            {hasCameraPermission === false && (
      ...
      case "processing":
        return (
          <div className="flex flex-col items-center justify-center h-48 space-y-4">
            ...
            <p className="font-semibold">Verifying Credential...</p>
      ...
      case "success":
        return (
          <div className="flex flex-col items-center justify-center h-48 space-y-4 text-center">
            ...
            <p className="text-muted-foreground">The credential has been successfully verified.</p>
        ...
        return (
          <div className="flex flex-col items-center justify-center h-48 space-y-4 text-center">
            ...
            <p className="text-muted-foreground">
              Could not verify the credential. The code may be invalid.
            </p>
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-xl font-bold font-headline">Scan to Verify</h2>
      </div>
